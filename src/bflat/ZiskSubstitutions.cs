...
using ILLink.Shared;
// Policy for the zisk/zisk_sim targets: WHICH CoreLib method bodies are
    ...
    internal static Dictionary<MethodDesc, MethodDesc> BuildBodySubstitutions(CompilerTypeSystemContext ctx, EcmaModule snippetsModule)
    {
        ...
        if (drift.Count != 0)
        {
            ...
            throw new InvalidOperationException(
                ...
                "kept. Update zisk.snippets.cs / ZiskSubstitutions.BuildBodySubstitutions for " +
